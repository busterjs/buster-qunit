...
(function () {
    ...
    qunit.wrapTest = function (inner, proto) {
        ...
        function outer() {
            ...
            qunit.promise.then(function () {
                if (qunit.promise.expected !== null &&
                        buster.assertions.count < qunit.promise.expected) {
                    buster.assertions.fail('[expect] Expected (' + qunit.promise.expected +
                        ') assertions, instead found (' + buster.assertions.count +
                        ').');
                }
            });
